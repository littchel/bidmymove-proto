...
export default function PostJobDetails() {
  const handleSubmit = (e: any) => {
    e.preventDefault();
    // Standard browser navigation to bypass Next.js build-time errors
            ...
            <div className="text-left">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-5 py-5 bg-white rounded-3xl border-none shadow-sm text-lg font-medium outline-none" 
                />
              </div>
            </div>
