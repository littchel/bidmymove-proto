...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white text-[#1F2937] font-sans selection:bg-emerald-100">
      {/* Navigation - Fixed & Purpose-Driven */}
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 text-left">
      ...
      {/* Hero Section - Happy Couple & Clean Text */}
      <header className="pt-16 pb-24 bg-gradient-to-b from-white to-gray-50 overflow-hidden text-left lg:text-left">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="text-left">
            ...
            <p className="text-xl text-gray-500 mb-10 leading-relaxed font-medium max-w-lg">
              Why pay fixed rates when you can get competitive bids? Connect with verified truck owners through BidMyMove and save.
            </p>
          ...
          <div className="relative flex justify-center lg:justify-end">
             <div className="relative w-full max-w-[500px] h-[500px]">
                ...
                <div className="absolute top-1/2 -left-10 z-20 bg-white p-5 rounded-2xl shadow-2xl border border-gray-100 flex items-center gap-4 animate-bounce">
                   ...
                   <div className="text-left">
                      ...
                      <p className="text-[10px] text-gray-400 font-bold">"1-ton truck ready to move!"</p>
                   </div>
                </div>
             </div>
          </div>
      ...
      <section id="how-it-works" className="py-24 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 text-left">
          <h2 className="text-4xl font-black text-center mb-16 italic tracking-tighter text-[#1F2937]">How BidMy<span className="text-emerald-600 font-black">Move</span> Works</h2>
          <div className="grid md:grid-cols-3 gap-12 text-left">
            {[
              ...
              <div key={i} className="relative p-10 bg-gray-50 rounded-[2.5rem] border border-gray-100 group hover:bg-emerald-600 transition-all duration-500 text-left">
      ...
      {/* Driver Section - RESTORED PURPOSE */}
      <section id="fleet" className="py-24 bg-[#1F2937] overflow-hidden relative text-left">
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div className="bg-emerald-600 rounded-[3rem] p-12 lg:p-20 shadow-2xl relative overflow-hidden text-left">
            <h2 className="text-5xl font-black mb-6 text-white tracking-tight leading-[1.1]">Own a Truck? <br />Start Earning.</h2>
            <p className="text-emerald-50 text-xl mb-10 font-medium max-w-md">Join South Africa's fastest-growing logistics fleet. Get access to thousands of daily loads.</p>
          ...
          <div className="bg-white p-10 rounded-[3.5rem] shadow-2xl border border-gray-100 max-w-md ml-auto text-[#1F2937]">
            <div className="flex justify-between items-center mb-8 border-b border-gray-100 pb-6 text-left">
              <div className="text-left">
                ...
                <h3 className="text-2xl font-black italic tracking-tighter">Fleet Portal</h3>
              </div>
            ...
            <div className="text-left">
              ...
              <p className="text-5xl font-black tracking-tight italic">R12,450.00</p>
              <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100 mt-8">
                <p className="text-[10px] font-black text-emerald-700 uppercase tracking-widest mb-2">Next Job: 15 mins</p>
                <p className="text-xl font-black italic tracking-tight italic">Sandton → Pretoria CBD</p>
              </div>
            </div>
          </div>
        </div>
